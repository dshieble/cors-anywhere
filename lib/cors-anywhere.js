...
function withCORS(headers, request) {
  ...
  if (request.headers['access-control-request-credentials']) {
    headers['access-control-allow-credentials'] = true;//request.headers['access-control-request-credentials'];
    delete request.headers['access-control-request-credentials'];
  }

  console.log('----\n\n\nheaders\n', headers, '\n\n\n----')

  // TODO: Figurte out why the allow credentials isnt going thriugh - https://stackoverflow.com/questions/63351799/react-fetch-credentials-include-breaks-my-entire-request-and-i-get-an-error
...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  // console.log("\n\n\n\n\n\n\n====\n(onProxyResponse-proxy)\n====\n", proxy, "\n\n\n\n\n\n\n========\n\n\n\n\n\n\n")
  // console.log("\n\n\n\n\n\n\n====\n(onProxyResponse-proxyReq)\n====\n", proxyReq, "\n\n\n\n\n\n\n========\n\n\n\n\n\n\n")
...
function getHandler(options, proxy) {
  ...
  var hasRequiredHeaders = function(headers) {
    return !corsAnywhere.requireHeader || corsAnywhere.requireHeader.some(function(headerName) {
      var out = Object.hasOwnProperty.call(headers, headerName);
      console.log("headers", headers);
      console.log("[hasRequiredHeaders] headerName " + headerName + " present: " + out);
      return out
    });
  };
